...
<Steps>
  ...
  <Step title="Pick a model">
    In the Test panel, choose a model. Use a **Viorant** tier — Low, Mid, or High — to
    run on credits, or [add your own provider key](/providers/byok) and pick one of
    yours.
  </Step>
  <Step title="Test it">
...
<Tip>
  Start on **Low** while you're iterating on wording — it's the cheapest tier and
  usually enough to tell whether a prompt is heading the right way. Move up to Mid or
  High for the runs that matter.
</Tip>
