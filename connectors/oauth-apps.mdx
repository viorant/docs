...
You can add **any** remote MCP server by its URL. These guides cover the most common
services; for anything else, add the server's URL and — if it asks for one — supply
your own Client ID and Secret from that service's developer settings.
